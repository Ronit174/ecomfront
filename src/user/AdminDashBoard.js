  ...
  const adminRightSide =() =>{
    ...
    return (
      <div className="card mb-4">
        ...
        <ul className="list-group">
          <li className="list-group-item">
             <span className="badge bg-info text-dark ">Name:</span> {name}
          </li>
          <li className="list-group-item">
             <span className="badge bg-info text-dark">Email:</span> {email}
          </li>
    ...
    return (
        <Base title="Welcome Founder !" description="Manage your all products here" className="container bg-info p-4">
